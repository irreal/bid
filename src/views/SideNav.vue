...
<aside class="sidenav" :class="{'sidenav--active':menuOpen}">
    ...
    <div class="row row--align-v-center row--align-h-center">
      <ul class="navList">
        ...
        <li>
          <div class="navList__subheading row row--align-v-center">
            <span class="navList__subheading-icon"><i class="fas fa-dollar-sign"></i></span>
        ...
        <li>
          <div class="navList__subheading row row--align-v-center">
            <span class="navList__subheading-icon"><i class="fas fa-funnel-dollar"></i></span>
        ...
        <li>
          <div class="navList__subheading row row--align-v-center">
            <span class="navList__subheading-icon"><i class="fas fa-lock"></i></span>
